...
const config: Config = {
  ...
  projectName: 'sequelize-dart', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          // editUrl: 'https://github.com/your-org/sequelize-dart/tree/main/',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/crazidev/sequelize_orm_dart',
          label: 'GitHub',
          position: 'right',
        },
      ],
