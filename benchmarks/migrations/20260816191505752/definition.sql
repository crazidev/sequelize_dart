...
--
-- Class PostDetail as table post_details
--
...
--
-- MIGRATION VERSION FOR orm_benchmarks
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('orm_benchmarks', '20260816191505752', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260816191505752', "timestamp" = now();
